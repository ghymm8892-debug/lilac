  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProductDetailsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductDetailsRow> productProductDetailsRowList = snapshot.data!;

        final productProductDetailsRow = productProductDetailsRowList.isNotEmpty
            ? productProductDetailsRowList.first
            : null;
                          ...
                          Column(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.network(
                                  productProductDetailsRow!.imgList!,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      productProductDetailsRow.about,
                                      'xyz',
                                    ),
                                    textAlign: TextAlign.start,
                                    maxLines: 4,
