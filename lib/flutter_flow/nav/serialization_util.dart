      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case AppRow:
            return AppRow(data);
          case CartTotalsRow:
            return CartTotalsRow(data);
          case CheckoutTotalsRow:
            return CheckoutTotalsRow(data);
          case FavouritRow:
            return FavouritRow(data);
          case FullOrdersListRow:
            return FullOrdersListRow(data);
          case FullOrdersSummaryRow:
            return FullOrdersSummaryRow(data);
          case NotificationRow:
            return NotificationRow(data);
          case Order2Row:
            return Order2Row(data);
          case Order2ViewRow:
            return Order2ViewRow(data);
          case OrdersRow:
            return OrdersRow(data);
          case OrdersWithAddressRow:
            return OrdersWithAddressRow(data);
          case ProductDetailsRow:
            return ProductDetailsRow(data);
          case ProductsRow:
            return ProductsRow(data);
          case SlidersRow:
            return SlidersRow(data);
          default:
            return null;
        }
